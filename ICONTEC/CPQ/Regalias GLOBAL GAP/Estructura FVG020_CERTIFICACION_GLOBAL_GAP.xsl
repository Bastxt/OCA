...
<fo:block space-before="">
    ...
    <xsl:variable name="regalias" select="/transaction/data_xml/document[@document_var_name='transactionLine'and starts-with(item_l/_part_number,'VA2050301') and not(fase='Viaticos') and tipoDeEsquema = 'simple' and facturable = 'true']"/>
    <xsl:variable name="countRegalias" select="count($regalias)"/>
                ...
                <fo:table-row>
                    <fo:table-cell border="solid 0.4mm black" border-style="solid">
                        <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                            <fo:inline font-weight="bold">Opción de certificación</fo:inline>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell border="solid 0.4mm black" border-style="solid">
                        <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                            <xsl:choose>
                                <xsl:when test="$opcer = 'opcion1'">
                                    Opción 1 <fo:inline border-style="solid" border-width="1pt">&#160;&#160;x&#160;&#160;</fo:inline>
                                </xsl:when>
                                <xsl:otherwise>
                                    Opción 1 <fo:inline border-style="solid" border-width="1pt">&#160;&#160;&#160;&#160;</fo:inline>
                                </xsl:otherwise>
                            </xsl:choose>
                        </fo:block>
                    </fo:table-cell>
                        ...
                        <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                            <xsl:choose>
                                <xsl:when test="$opcer = 'opcion2'">
                                   |Opción 2 <fo:inline border-style="solid" border-width="1pt">&#160;&#160;x&#160;&#160;</fo:inline>
                                </xsl:when>
                                <xsl:otherwise>
                                    Opción 2 <fo:inline border-style="solid" border-width="1pt">&#160;&#160;&#160;&#160;</fo:inline>
                                </xsl:otherwise>
                            </xsl:choose>
                        </fo:block>
                    </fo:table-cell>
    ...
    <fo:block space-before="20px">
        <xsl:if test="$countRegalias!=0">
            <fo:block-container height="20%" display-align="center">
                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="center">
                    <fo:inline font-weight="bold">REGALIAS GLOBAL GAP</fo:inline>
                </fo:block>
            </fo:block-container>
            <!-- TABLA DE SEGUIMIENTOS -->
            <fo:block>
