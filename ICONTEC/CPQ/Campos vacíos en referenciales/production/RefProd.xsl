                        ...
                        <fo:table-row>
                            <fo:table-cell border="solid 0.4mm black" border-style="solid">
                                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                                    <xsl:value-of select="attribute[@var_name='referencialDeCertificacin']"/>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="solid 0.4mm black" border-style="solid">
                                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                                    <xsl:variable name="pSa" select="attribute[@var_name='procesoOServicioACertificar']"/>
                                    <xsl:value-of select="$pSa"/>
                                    <xsl:value-of select="attribute[@var_name='procesoOServicioACertificar']"/>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="solid 0.4mm black" border-style="solid">
                                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                                    <xsl:value-of select="attribute[@var_name='esquemaDeCertificacin']"/>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="solid 0.4mm black" border-style="solid">
                                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                                    <xsl:value-of select="attribute[@var_name='tipoDeServicioProducto']"/>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="solid 0.4mm black" border-style="solid">
                                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                                    <xsl:value-of select="attribute[@var_name='vigenciaDeLaCertificacin']"/>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="solid 0.4mm black" border-style="solid">
                                <fo:block color="#28324D" font-family="sans-serif" font-size="10pt" text-align="left">
                                    <xsl:value-of select="attribute[@var_name='tipoDeAcreditacin']"/>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    </xsl:for-each>
